...
footer = dbc.Container(dbc.Row(dbc.Col(html.P([
    html.Span('Robert Sharp', className='mr-2'),
    html.A(
        html.I(className='fas fa-envelope-square mr-1'),
        href='mailto:webmaster@sharpdesigndigital.com',
    ),
    html.A(
        html.I(className='fab fa-github-square mr-1'),
        href='https://github.com/BrokenShell',
        target='_blank',
    ),
    html.A(
        html.I(className='fab fa-linkedin mr-1'),
        href='https://www.linkedin.com/in/robert-w-sharp/',
        target='_blank',
    ),
], className='lead'))))
